const CACHE = "fraud-lab-master-v21";
const CORE = ["./", "./index.html", "./master-v3.css?v=16", "./master-v4.css?v=21", "./master-v3.js?v=16", "./quickscan-v2.js?v=19"];
...
async function pageWithQuickScan(req){
  ...
  if(!html.includes("master-v4.css"))html=html.replace("</head>",'<link rel="stylesheet" href="./master-v4.css?v=21"></head>');
